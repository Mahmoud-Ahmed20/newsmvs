        ...
        <div class="card-body">
         <form role="form" action="/admincategory/PostUpdate" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>icon</label>
                    <input type="text" class="form-control"value='<?= $data['icon']; ?>' name="icon" placeholder="icon">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">img</label>
                    <br> 
                    <img src="<?= DESIGN."img/".$data['img']; ?>" width="100px" height="100px" alt="">
                    <div class="input-group">
                    <div class="custom-file">
                        <input type="file"value='<?= $data['imge']; ?>' name="img" class="custom-file-input" id="exampleInputFile">
