...
<html lang="en">
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?=DESIGN;?>front/css/bootstrap.css" rel="stylesheet">

    <!-- FontAwesome Icons core CSS -->
    <link href="<?=DESIGN;?>front/css/font-awesome.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="<?=DESIGN;?>front/css/style.css" rel="stylesheet">

    <!-- Responsive styles for this template -->
    <link href="<?=DESIGN;?>front/css/responsive.css" rel="stylesheet">

    <!-- Colors for this template -->
    <link href="<?=DESIGN;?>front/css/colors.css" rel="stylesheet">
            ...
            <div class="container">
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                        ...
                        <!-- <img src="<?= DESIGN."img/".$c->img;?>"width="100px" height="100px" alt=""> -->
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
