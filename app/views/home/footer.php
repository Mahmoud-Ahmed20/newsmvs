<footer class="footer">
    ...
    <!-- Core JavaScript
    ================================================== -->
    <script src="<?=DESIGN;?>front/js/jquery.min.js"></script>
    <script src="<?=DESIGN;?>front/js/tether.min.js"></script>
    <script src="<?=DESIGN;?>front/js/bootstrap.min.js"></script>
    <script src="<?=DESIGN;?>front/js/custom.js"></script>
